...
refinement choices are configurable via flags.
...
individual claims (OpenFEMA's ``FIMA NFIP Redacted Claims v2'')~\cite{fema_nfip_claims_v2}, which
...
v1.1 precipitation reanalysis~\cite{fall_analysis_2023}. Every major choice in the pipeline, including which Census boundary
