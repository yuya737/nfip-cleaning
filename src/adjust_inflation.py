...
Target year defaults to 2021 because that is the valuation vintage of the
2022 public National Structure Inventory release used in the NSI-refinement
step (refine_with_nsi.py) — claim building values and NSI structure
values need to be in the same dollar-year to be comparable there. Pass
--target-year to adjust to a different year for other uses.
"""
